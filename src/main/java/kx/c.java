...
import java.io.*;import java.sql.*;import java.lang.reflect.Array;import java.text.*;import java.util.UUID;
/*
...
// George's qdecoder api - 
private static final Logger log = LoggerFactory.getLogger(c.class);
		
	public Object k2() throws KException, IOException, UnsupportedEncodingException {
		synchronized (i) {
			// read header
			i.readFully(b = new byte[8]);
			
			log.info("header:0x{}", javax.xml.bind.DatatypeConverter.printHexBinary(b));
			...
			log.info("data:  0x{}", javax.xml.bind.DatatypeConverter.printHexBinary(b));
	...
	Object r2() throws UnsupportedEncodingException {
		int i = 0, n, t = b[j++];
